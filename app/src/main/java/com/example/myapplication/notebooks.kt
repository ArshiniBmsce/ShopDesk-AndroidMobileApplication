...
class notebooks : AppCompatActivity() {
    ...
    private val img= arrayOf(R.drawable.spiral, R.drawable.a5, R.drawable.classmate, R.drawable.packof6, R.drawable.rough, R.drawable.unruled)
    private val text= arrayOf("Spiral","A5 notebook","Classmate ruled notebook","Pack of 6 notebook",
        "Rough Notebook","Unruled","Blank Spiral notebook")
    private val price= arrayOf("Rs.150","Rs.70","Rs.60","Rs.320","Rs.50","Rs40","Rs.100")
...
class notebooks : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerView.layoutManager= LinearLayoutManager(this)
        recyclerView.adapter= CustomerAdapter(img,text,price)
